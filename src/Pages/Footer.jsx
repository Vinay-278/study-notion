...
const Footer = () => {
    ...
    const Resource=["Articles","Blog","Chart Sheet", "Code challenge", "Docs", "Project", "Videos","Workspaces"]
    ...
    <div className="text-white w-full flex gap-x-12 justify-evenly text-[15px]">
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {company.map((item, key) => (
            <div className="text-[#999DAA]">{item}</div>
          ))}
        </div>
      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="text-[#999DAA]">Help Center</div>
        </div>
      </div>
      {/* footer3 */}
      <div>
      ...
      {/* footer4 */}
      <div className="flex">
        {FooterLink2.map((ele, key) => (
          <div className="flex flex-col gap-2 font-semibold">
            {ele.title}
            {ele.links.map((item, ke) => (
              <div className="text-[#999DAA] ">{item.title}</div>
            ))}
          </div>
        ))}
      </div>
